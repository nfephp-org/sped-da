...
class Danfce extends Common
{
    ...
    public function montaDANFE(
        ...
        //COLOCA Contingência
        if ($this->tpEmis == 9) {
            $y = $xInic + $hcabecalho + $hcabecalhoSecundario + $hprodutos + $hTotal + $hpagamentos + $hmsgfiscal + $hcliente + 1;
            $y = $this->pContingencia($x, $y, $hcontingencia);
        }
        //COLOCA QRCODE
        $y = $xInic + $hcabecalho + $hcabecalhoSecundario + $hprodutos + $hTotal + $hpagamentos + $hmsgfiscal + $hcliente + 1 + $hcontingencia;
        $jj = $y + $hQRCode;
