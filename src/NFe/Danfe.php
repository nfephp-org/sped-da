...
class Danfe extends Common
{
    ...
    protected function pDadosItenVeiculoDANFE($x, $y, &$nInicio, $h, $prod)
    {
        ...
        $this->pTextBox($xVeic, $yVeic, $w1+50, $h, $texto, $aFont, 'T', 'L', 0, '');
        $yVeic += $h;
        $texto = 'Especie..................: ' . $renavamEspecie[intval($veiculoEspecie)] ?? intval($veiculoEspecie);
        $this->pTextBox($xVeic, $yVeic, $w1+50, $h, $texto, $aFont, 'T', 'L', 0, '');
        $yVeic += $h;
        $texto = 'Combustivel..........: ' . $renavamCombustivel[intval($veiculoCombustivel)] ?? intval($veiculoCombustivel);
        $this->pTextBox($xVeic, $yVeic, $w1+50, $h, $texto, $aFont, 'T', 'L', 0, '');
        $yVeic += $h;
