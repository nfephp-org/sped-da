...
class Danfe extends DaCommon
{
     ...
     * @var boolean
     */
    public $exibirEmailDestanatario = true;
    /**
     ...
     * @param bool $exibirEmailDestanatario
     */
    public function setExibirEmailDestanatario($exibirEmailDestanatario = true)
    {
        $this->exibirEmailDestanatario = filter_var($exibirEmailDestanatario, FILTER_VALIDATE_BOOLEAN);
    }
    ...
    protected function calculoEspacoVericalDadosAdicionais()
    {
        ...
        if (isset($this->infAdic)) {
            ...
            if($this->exibirEmailDestanatario){
